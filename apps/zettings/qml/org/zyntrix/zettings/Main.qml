...
ApplicationWindow {
    ...
    Rectangle {
        ...
        gradient: Gradient {
            GradientStop {
                position: 0.0
                color: ZdlTheme.darkAppearance ? "#17113a" : "#efe9ff"
            }
            GradientStop {
                position: 1.0
                color: ZdlTheme.surface
    ...
    Rectangle {
        ...
        gradient: Gradient {
            ...
            GradientStop {
                position: 0.0
                color: Qt.rgba(0.486, 0.227, 0.929, 0.55)
            }
            GradientStop {
                position: 0.55
                color: "transparent"
    ...
    Rectangle {
        ...
        gradient: Gradient {
            ...
            GradientStop {
                position: 1.0
                color: Qt.rgba(0.055, 0.627, 0.604, 0.50)
            }
        }
    }
    ...
    Frame {
        ...
        background: Squircle {
            ...
            fillColor: ZdlTheme.glassEnabled ? Qt.rgba(ZdlTheme.surfaceElevated.r, ZdlTheme.surfaceElevated.g, ZdlTheme.surfaceElevated.b, ZdlTheme.darkAppearance ? 0.55 : 0.42) : ZdlTheme.surfaceElevated
