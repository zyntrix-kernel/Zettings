...
```yaml
canonical_source: examples/ANCHOR_LINKS_ACCESSIBILITY_BEST_PRACTICES.md
...
notes: >
  ...
  CORRECTION: scroll-spy current-section marker is aria-current="location",
  not aria-current="true" as the prior skill version used. Also added
  heading permalinks, back-to-top pattern, SPA/router fragment-navigation
  guidance, and a common-failures table.
...
5. Rebuild: `cd skills && zip -r anchor-links.skill anchor-links/`
